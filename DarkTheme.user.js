...
(function() {
  ...
  var darkThemeSwitch, csslist, blackList = Array(), pageFirstLoad = true;
  ...
  function concatCss() {
    let ag = GMgetValue('csslist', JSON.stringify(defaultCSSlist));
  ...
  function TMBlackList() {
    let blist = GMgetValue('blackList', '{"null":false}');
